...
version: "v9.2"
subsector: "Petroleum & Petrochemical"
date: "2026-06-05"
authors:
  - "自动生成"
tags: ["石油石化", "Petroleum & Petrochemical", "申万一级"]
---

# 1️⃣ 版本选择
> 本案例使用 **v9.2** 框架。

**选择理由**：石油石化 属于 Petroleum & Petrochemical 类别，{{ "具有显著网络效应，适合双模分析。" if version == "v10.x" else "产业链结构相对线性，适合传统四层链分析。" }}
